...
export default class Eqinfo extends React.Component {
  whatsappShareHandle() {
    Linking.openURL(`whatsapp://send?text=${shareLinkContent.quote}`).catch(
      () => {
        Alert.alert(
          "",
        ...
        <View style={{ flex: 1 }}>
          <View style={styles.cardContainer}>
            <View style={styles.cardHeader}>
              <View
                style={[
                  ...
                  {
                    backgroundColor: notification.data.predicted_intensity_rgb,
                  },
                ]}
              >
              ...
              <View>
                ...
                <Label style={[styles.cardHeaderLabel, { color: color.gray }]}>
            ...
            <Image
              ...
              source={{
                uri: `https://api.mapbox.com/styles/v1/mapbox/streets-v10/static/${notification.data.longitude},${notification.data.latitude},10.67/1000x600@2x?access_token=${config.mapBoxKey}`,
              }}
            />
          </View>
          ...
          <View style={[styles.cardContainer, { width: "90%" }]}>
            ...
            <View style={styles.shareLinkContainer}>
              ...
              <Button
                ...
                onPress={() =>
                  Linking.openURL(
                    `https://twitter.com/intent/tweet?text=${shareLinkContent.quote}`
                  )
                }
              >
              ...
              >
                <FontAwesome
                  name="whatsapp"
                  style={[styles.icon, { fontSize: vw * 5 }]}
                />
              </Button>
            </View>
          </View>
